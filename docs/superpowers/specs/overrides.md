...
- task-id: AGE-2399
  ...
  reason: founder asked where the résumé is on /poppy "like I have it on the hire page"; the placeholder promised a forthcoming asset with no download, the hire page already serves the Sept-21 ATS PDF and the 2-page master. Type sizes on the route raised one step (9–14px → 10–16px) and mono/body weight to 500/450 for readability; no other copy changed.
