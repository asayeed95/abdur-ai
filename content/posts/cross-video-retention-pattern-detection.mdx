...
seo_title: "Cross-video YouTube retention patterns"
subtitle: "Retention curves are gold — and trapped per-video"
description: "YouTube retention curves stay trapped one video at a time, so the same structural mistake repeats invisibly across a channel. How I would surface it."
