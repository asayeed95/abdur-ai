...
description: "Migration 031 revoked two columns and the dashboard's select('*') died with it. Postgres checks column privileges before rows: 42501 on every page load."
