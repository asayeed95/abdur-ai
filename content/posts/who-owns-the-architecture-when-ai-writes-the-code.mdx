...
seo_title: "Who owns the architecture when AI writes code"
subtitle: "The honest version of AI-native building"
description: "AI writes most of my code and I own every decision. The test that separates the two: explain a decision, then change it. Otherwise you are a passenger."
