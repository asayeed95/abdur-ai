...
register: argued
status_note: "Argument. The incident it recounts predates the receipts ledger; no artifact is attached."
flagship: false
pinned: false
featured: false
reading_time: 4
...
- **Defining what "correct" means.** The model will happily generate something that runs and is wrong. The eval, the test, the question of whether it returns the right caller context within a stated design target — that's mine.
