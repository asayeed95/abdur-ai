...
That's the whole story, and it's the same story as [the agent-audit one](/writing/the-night-the-doctrine-failed): a thing can pass every check you happen to be running and still be broken. There it was Potemkin *verification*. Here it was Potemkin *done*.
