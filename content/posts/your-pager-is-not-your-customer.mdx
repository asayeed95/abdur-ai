...
register: reported
receipts:
  - path: "Sentry — production synthetic health cron"
    note: "First seen 2026-08-12T17:08:08.393Z. The post states this is first-seen, not a proven start-of-failure."
  - path: "Sentinel packet"
    note: "Collected 2026-08-22; the 60-second sample the post analyses."
...
![Four evidence states: signal, diagnosis, mitigation, recovery; abort 100ms vs warn 2000ms.](/blog/your-pager-is-not-your-customer/four-evidence-states-variant-b.svg)
