...
date: "2026-08-23"
register: argued
status_note: "Argument. Grounded in public vendor docs, not a measured incident."
...
description: "A phone number is a channel, not a person. Voice agents that key memory to it replay the last caller on a shared line. A failure class, not a story."
dek: "Voice agents that persist contact memory on the phone number will replay the last caller on a shared line. Public Retell and ElevenLabs docs describe the pattern. This is a failure class, not a customer story. No wipe, no price, no Northsun usage claim."
tags:
  - voice
  - identity
  - memory
